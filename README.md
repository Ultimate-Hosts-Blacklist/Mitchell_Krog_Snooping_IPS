# About Mitchell_Krog_Snooping_IPS

[![Build Status](https://travis-ci.org/Ultimate-Hosts-Blacklist/Mitchell_Krog_Snooping_IPS.svg?branch=master)](https://travis-ci.org/Ultimate-Hosts-Blacklist/Mitchell_Krog_Snooping_IPS)

```
IP's caught snooping in deliberate traps set on my Servers.
